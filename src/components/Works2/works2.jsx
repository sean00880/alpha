...
const Works2 = ({ sliderRef }) => {
  ...
  return (
    <>
      ...
      <section className="work-carousel section-padding caroul position-re pb-0" id="works">
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          ...
                          <div className="cont bgbox">
                            <h6>
                              <Link
                                href={`/project-details2/decoded-web`}
                              >
                                <a>Graphic Design</a>
                              </Link>
                            </h6>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          ...
                          <div className="cont bgbox">
                            <h6>
                              <Link
                                href={`/project-details2/afj-productions`}
                              >
                                <a>Website Desgin</a>
                              </Link>
                            </h6>
                            <h4>
                              <Link
                                href={`/project-details2/afj-productions`}
                              >
                                <a>Web Design for AFJ Productinons</a>
                              </Link>
                            </h4>
                          </div>
                        </div>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          ...
                          <div className="cont bgbox">
                            <h6>
                              <Link
                                href={`/project-details2/site-dominion`}
                              >
                            ...
                            <h4>
                              <Link
                                href={`/project-details2/site-dominion`}
                              >
                                <a>Marketing Campaign for Site Dominion</a>
                              </Link>
                            </h4>
                          </div>
                        </div>
